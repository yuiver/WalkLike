...
public class StopUIButtonHandler : BaseButtonHandler, IPointerEnterHandler, IPointerClickHandler
{
    ...
    public void OnPointerEnter(PointerEventData eventData)
    {
        ...
        inGameCanvasController.ActivateStopUISingleButton(buttonIndex);
    }
    public void OnPointerClick(PointerEventData eventData)
    {
        ...
        {
            case 0:
                inGameCanvasController.ContinueButton();
                break;
            case 1:
                //SoundManager.Instance.Play("UI/menu_select_01", Sound.UI_SFX);
                inGameCanvasController.OptionMenuActive();
                break;
            case 2:
                GFunc.QuitThisGame();
                break;
