...
{
    public static T GGetOrAddComponent<T>(GameObject go) where T : UnityEngine.Component
    {
    ...
    public static T CreateAndSetParent<T>(string objName,GameObject parent) where T : Component
    {
        GameObject newObj = new GameObject(objName);
